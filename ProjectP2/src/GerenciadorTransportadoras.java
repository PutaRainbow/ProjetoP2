...
public class GerenciadorTransportadoras {
    ...
    public void adicionarTransportadoraInterna(Consola consola) {
        ...
        if (consola.desejaProsseguir()) {
            ...
            transportes.adicionarTransportadoraInterna(interna);
    ...
    public void adicionarTransportadoraExterna(Consola consola) {
        ...
        if (consola.desejaProsseguir()) {
            ...
            transportes.adicionarTransportadoraExterna(externa);
    ...
    public void atualizarTransportadora(Consola consola) {
